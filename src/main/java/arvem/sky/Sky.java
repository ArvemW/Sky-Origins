...
public class Sky implements ModInitializer {
	...
	public static final Item WEAK_WL = new Item(new Item.Settings().group(ItemGroup.COMBAT).maxCount(1).fireproof().rarity(Rarity.UNCOMMON));
	...
	public void onInitialize() {
		...
		Registry.register(Registry.ITEM, new Identifier("sky", "weak_wl"), WEAK_WL);
		Sounds.registerflap();
